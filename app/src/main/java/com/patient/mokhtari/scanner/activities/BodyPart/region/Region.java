 ...
 */
public enum Region {
    HEAD ("سر", 1, LayoutSide.LEFT, 47, 38, 0),
    EYE ("چشم", 2, LayoutSide.LEFT, 49, 80, 0, 1),
    FACE ("گونه", 5, LayoutSide.LEFT, 39, 121, 0, 2),
    THROAT ("گلو", 6, LayoutSide.LEFT, 0, 199, 0, 3),
    EAR ("گوش", 3, LayoutSide.RIGHT, 68, 82, 0),
    NOSEMOUTH ("بینی", 4, LayoutSide.RIGHT, 0, 135, 0, 1),
    NECK ("گردن", 7, LayoutSide.RIGHT, 33, 192, 0, 2),
    SKIN ("پوست", 17, LayoutSide.RIGHT, 0, 0, 0, 1),
    ARM("بازو", 10, LayoutSide.RIGHT, 170, 465, 335),
    HAND("دست", 9, LayoutSide.LEFT, 245, 695, 545),
    SHOULDER("شانه", 8, LayoutSide.LEFT, 120, 250, 338),
    CHEST("سینه", 11, LayoutSide.RIGHT, 59, 364, 125),
    ABDOMEN("شکم", 13, LayoutSide.LEFT, 0, 581, 415),
    WAIST("کمر", 12, LayoutSide.LEFT, 112, 600, 415, 1),
    PELVIC("لگن", 14, LayoutSide.RIGHT, 0, 687, 405),
    LEG("ران", 15, LayoutSide.LEFT, 83, 877, 1026),
    FOOT("پا", 16, LayoutSide.RIGHT, 56, 1313, 890), //1026
