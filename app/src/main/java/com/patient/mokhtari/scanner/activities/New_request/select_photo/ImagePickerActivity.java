package com.patient.mokhtari.scanner.activities.New_request.select_photo;
...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private Uri getCacheImagePath(String fileName) {
        ...
        return getUriForFile(ImagePickerActivity.this, getApplicationContext().getPackageName() + ".provider", image);
    }
