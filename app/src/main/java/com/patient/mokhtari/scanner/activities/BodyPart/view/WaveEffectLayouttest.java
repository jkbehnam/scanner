 ...
 */
public class WaveEffectLayouttest extends FrameLayout implements Runnable {
    ...
    public WaveEffectLayouttest(Context context) {
        super(context);
        init();
    }

    public WaveEffectLayouttest(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public WaveEffectLayouttest(Context context, AttributeSet attrs, int defStyleAttr) {
